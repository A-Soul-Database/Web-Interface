...
const queryAPI = "http://47.93.157.77/Api/Subtitle_Search/sub_search";
const urlChoice = 0;
const APIHost = "http://47.93.157.77/Api/List_Json/V1";// https://github.com/A-Soul-Database/API/tree/master/Main-Api 的API，用于获取json文件
export const config =  {
