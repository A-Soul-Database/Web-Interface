...
const staffMap = {"A":"向晚","B":"贝拉","C":"珈乐","D":"嘉然","E":"乃琳","F":"None"};
...
const skinMap = {"swim":"泳装","official":"官方","sport":"运动服(贝拉)","jk":"jk","chinese":"古风旗袍(嘉然)","group":"团服","birthday":"生日会服装","sleep":"睡衣","christmas":"圣诞服","year":"新年装","DianaOfficialBlue":"蓝色常服(嘉然)","JinLing":"金陵","LegendWorld":"传说的世界","creamy":"香草(嘉然百万粉)","DailySuit":"常服","22Birthday":"生日服(2022)","foxy":"乃琳狐服"};
const platformMap = {"B":"B站","D":"抖音"}
const toolMap = {"staff":["出镜成员",staffMap],"skin":["服饰",skinMap],"scene":["出场场景",sceneMap],"platform":["平台",platformMap],"type":["活动",typeMapStr]};
    ...
    return (
      <Card
        ...
        <Collapse>
          ...
          <Card>
          <p>筛选Tips:</p>
          <p>筛选特定条目时尽量取消选择其他条目🙇‍♀️</p>
          <p>例如: 在<b>仅筛选成员时把其他条目的全选取消勾选</b></p>
          </Card>
